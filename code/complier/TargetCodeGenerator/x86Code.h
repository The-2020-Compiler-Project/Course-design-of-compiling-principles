...
#ifndef COMPLIER_X86CODE_H
#define COMPLIER_X86CODE_H
...
//call指令
inline void CALLP(std::vector<code> &targetCodeArea, string name, string dest)
{
    code nowCode;
...
//lea指令
inline void LEA(std::vector<code> &targetCodeArea, string name, string dest, string o1)
{
    code nowCode;
    nowCode.name = name, nowCode.oper = "lea";
    nowCode.dest = dest, nowCode.source = o1;
    targetCodeArea.push_back(nowCode);
}
